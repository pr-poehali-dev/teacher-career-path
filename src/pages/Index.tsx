  ...
  const perspectives = [
    {
      ...
      points: [
        "Повышение квалификационной категории (первая, высшая)",
        "Административная работа (завуч, директор)",
        "Методическая работа (методист школы, управления образования)",
        "Экспертная деятельность (эксперт ЕГЭ, автор учебных материалов)"
      ],
      icon: "TrendingUp",
      color: "text-primary"
    },
    {
      title: "Реальные трудности",
      points: [
        "Зарплата растёт медленно (5-10% в год)",
        "Выгорание к 30-35 годам у 60% учителей",
        "Большая нагрузка при невысоком доходе",
    ...
    },
    {
      ...
      points: [
        "Престижность и нужность профессии в обществе",
